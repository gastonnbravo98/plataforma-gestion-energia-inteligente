...
public class ControladorOperacionesTest {
    ...
    @Test
    public void testComandosEncapsulanYEjecutanCorrectamente() {
    ...
    @Test
    public void testControladorEjecutaOperacionInmediata() {
        Bateria bateria = new Bateria("Bat-01", 100.0);
    ...
    @Test
    public void testControladorEjecutaRutinaYVaciaLaLista() {
        Bateria bateria = new Bateria("Bat-01", 100.0);
        ControladorOperaciones controlador = new ControladorOperaciones();
